...
```shell
go get -u github.com/724165435/go-wallet-sdk/coins/avax
```
...
## License
Most packages or folder are [MIT](<https://github.com/724165435/go-wallet-sdk/blob/main/coins/avax/LICENSE>) licensed, see package or folder for the respective license.
