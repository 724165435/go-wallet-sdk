...
```shell
go get -u github.com/724165435/go-wallet-sdk/coins/polkadot
```
...
## License
Most packages or folder are [MIT](<https://github.com/724165435/go-wallet-sdk/blob/main/coins/polkadot/LICENSE>) licensed, see package or folder for the respective license.
