...
```shell
go get -u github.com/724165435/go-wallet-sdk/coins/ton
```
...
Most packages or folder are [MIT](<https://github.com/724165435/go-wallet-sdk/blob/main/coins/ton/LICENSE>) licensed, see
