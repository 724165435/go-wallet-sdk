...
```shell
go get -u github.com/724165435/go-wallet-sdk/coins/tron
```
...
## License
Most packages or folder are [MIT](<https://github.com/724165435/go-wallet-sdk/blob/main/coins/tron/LICENSE>) licensed, see package or folder for the respective license.
